...
public class RecruitmentService {
	...
	public void printRecruitmentDetail(int recruitmentNo) {
		...
		System.out.println(recruitmentNo+"\t"+resume.getName()+"\t"+resume.getTel()+"\t"+resume.getDept()+"\t"+careers.+"\t"+recruitment.isPassed());
	...
	public void printAllRecruitment() {
		...
		System.out.println("구직신청번호\t이력서정보\t경력사항\t합격여부");
		for(Recruitment recruitment : recruitments) {
			System.out.println(recruitment.getNo()+"\t"+recruitment.getResume()+"\t"+recruitment.getCareers()+"\t"+recruitment.isPassed());
		}
	}
