...
public class ArrayListDemo1 {
	...
	public static void main(String[] args) {
		 ...
		 * 			1. 타입파라미터<E>는 특정타입만 저장하는 콜렉션을 생성한다. (타입 안정성)
		 * 			2. 저장소의 크기를 별도로 지정할 필요가 없다.
		 * 			3. 더 이상 저장할 공간이 없으면 곤간의 크기를 자동으로 조절한다.
		...
		// ArrayList 생성하기  <-----String객체를 담는 ArrayList 객체 생성
...
//		System.out.println(names);
		// 3. 일반 for 문 사용 (List의 자손들만 가능) *권장하지는 않습니다.
		...
		// 저장된 객체 전부 삭제하기
		names.clear();
		System.out.println("저장된 모든객체 삭제됨");
