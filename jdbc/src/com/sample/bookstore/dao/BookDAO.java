...
import com.smaple.bookstore.vo.Book;
...
public class BookDAO {
	...
	/**
	 * 지정된 제목을 포함하고있는 모든 책정보를 반환한다.
	 * @param title 검색할 책 제목
	 * @return 조회된 책정보가 없으면 빈 List객체가 반환된다. 절대 null일수 없다.
	 * @throws Exception
	 */
	 ...
	 * @throws Exception
	 */
	public List<Book> getBookByPriceRange(int minPrice, int maxPrice) throws Exception {
		List<Book> books = new ArrayList<Book>();
	 ...
	 * @param book 변경할 책정보가 포함된 Book 객체
	 * @throws Exception
	 */
